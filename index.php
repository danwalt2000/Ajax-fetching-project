...
Developer position</h1>
        ...
        <div class="h3__wrap">
          <h3 id="we__kindly" >We kindly remind you that your test assignment should be submitted
as a link to github/bitbucket repository. <span class="hide__in__mobile" >Please be patient, we consider
...
in the banner area on the different screens</span></h3>
        </div>
    </div>
    <div class="red__but__wrap1">
        <button class="red__button"><a href="#registration" >Sign up now</a></button>
    </div>
  </section>
  <!-- end of banner -->

  <section id="about__me" class="about__me">
    <div class="about__me__wrapper">
      <h1>Let's get acquainted</h1>
      <div class="graphic__and__article">
       <div class="svg__wrapper">
        <svg width="429px" height="362px" viewBox="0 0 429 362" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="graphic__and__article__text">
...
If 3rd party css/javascript libraries are added to the project via bower/npm/yarn you will get bonus points. If you use any task runner (gulp/webpack) you will get bonus points as well. Slice service directory page PSD mockup into HTML5/CSS3.
            ...
            <p class="sign"><a href="#registration"> Sign up now </a></p>
        </div>
      </div>
  ...
  <script src="scripts/media.js" type="text/javascript"></script>
